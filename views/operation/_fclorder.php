...
<div class="panel">
    <div class="panel-heading">
        <h4 class="panel-title text-bold-500">
            <b>Full Container Loading Step1 </b></font></h4>
	...
	<div class="row">
       <div class="col-md-10">
			...
			<?= $form->field($model, 'sas')->widget(DepDrop::classname(), ['type'=>DepDrop::TYPE_SELECT2,
                'data'=>$model->getSas(),'options' => ['placeholder' => 'Select','multiple' => false],
                'pluginOptions'=>[
                'depends'=>['fclshipping-cid'],
                'url'=>Url::to(['/operation/getsas'])
               ]
             ]) ?>
