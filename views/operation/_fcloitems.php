...
<div class="panel">
	...
	<h4 class="panel-title text-bold-500">
            <b>Add Full Container Items.</b></font>
        </h4>
	<?php echo $tbDet; ?><hr /><br />
	 ...
	 <?php $form = ActiveForm::begin(['enableClientValidation'=>false,'enableAjaxValidation'=>false,]); ?>
                    ...
                    <?php echo $tbInv ?>
					 ...
					 <table class='table table-bordered'><thead><tr bgcolor='#6495ed'><th><font color="#FFF"><b>Agreed Amount</b></font></th>
					 <th><font color="#FFF"><b>BL Number</b></font></th><th><font color="#FFF"><b>Action</b></font></th></tr></thead>
		             <tr><td><?= $form->field($model2, 'tamount')->label(false) ?></td>
