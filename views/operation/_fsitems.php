...
<div class="panel">
	...
	<h4 class="panel-title text-bold-500">
            <b>Cargo Items to Be Repacked Form.</b></font>
        </h4>
	<?php echo $tbDet; ?><hr /><br />
	 ...
	 <?php $form = ActiveForm::begin(['enableClientValidation'=>false,'enableAjaxValidation'=>false,]); ?>
		...
		<tr><td><?= $form->field($model, 'iid')->widget(Select2::classname(), [
            'data' => $this->context->getSQI($cid),'options' => ['placeholder' => 'Select'],
		...
		<th width=36%><font color="#FFF"><b>New Item Group</b></font></th><th><font color="#FFF"><b>Total CBM</b></font></th><th><font color="#FFF"><b>Total No Of Items</b></font></th><th><font color="#FFF"><b>Package Discription</b></font></th><th><font color="#FFF"><b>Action</b></font></th></tr></thead>
		<tr><td><?= $form->field($model2, 'iid')->widget(Select2::classname(), [
            'data' => $model2->getItems()])->label(false) ?></td>
		    <td><?= $form->field($model2, 'cbm')->label(false) ?></td>
			<td><?= $form->field($model2, 'nop')->label(false) ?></td>
			<td><?= $form->field($model2, 'descr')->textArea()->label(false) ?></td>
