...
<div class="panel">
    <div class="panel-heading">
        <h4 class="panel-title text-bold-500">
            <b>Clearing Progress Form&nbsp;&nbsp;|&nbsp;&nbsp;Documents should be in pdf,jpg or png format and Size Must Not Exceed 4MB.</b></font>
        </h4>
    ...
    <div class="row">
		...
		<?= $form->field($model, 'docid')->widget(Select2::classname(), [
         'data' =>$model->getDoc($model->jid),'options' => ['placeholder' => 'Select'],'pluginOptions' => ['allowClear' => true,],]) ?>
