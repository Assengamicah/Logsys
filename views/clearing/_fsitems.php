...
<div class="panel">
	...
	<?php echo $tbDet; ?><hr /><br />
	 ...
	 <?php $form = ActiveForm::begin(['enableClientValidation'=>false,'enableAjaxValidation'=>false,]); ?>
		...
		<th width=36%><font color="#FFF"><b>New Item Group</b></font></th><th><font color="#FFF"><b>Total CBM</b></font></th><th><font color="#FFF"><b>New Control Number</b></font></th><th><font color="#FFF"><b>Action</b></font></th></tr></thead>
		<tr><td><?= $form->field($model2, 'iid')->widget(Select2::classname(), [
			...
			<td><?= $form->field($model2, 'cno')->label(false) ?></td>
