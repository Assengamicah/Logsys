	 ...
	 <?php } ?>
		...
		<div class="row">
		 ...
		 <div class="form-group">
			<button type="submit" name ="btnRegister" class="btn primary btn-rounded pl-20 pr-20"><span class="text-regular small"> Register Role </span> <i class="icon-arrow-right13"></i>
			</button>
		</div> 
