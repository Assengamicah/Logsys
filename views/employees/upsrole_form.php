...
<div class="panel">
    <div class="panel-heading">
        <h4 class="panel-title text-bold-500">
            <b>Role Assignment Form.</b></font><hr />
        </h4>
		...
		<div class="col-md-3">
			<?= $form->field($model, 'tdate')->widget(DatePicker::classname(),[ 'pluginOptions' => ['autoclose' => true,'format' => 'dd/mm/yyyy','todayHighlight' => true ]]); ?>
			 ...
			 <div class="form-group text-center">
                <button type="submit" name ="btnRegister" class="btn primary btn-rounded pl-20 pr-20"><span class="text-regular small"> Update Staffrole </span> <i class="icon-arrow-right13"></i>
                </button>
            </div> 
