...
<div class="employees-view">
	...
	<p>
        <?= Html::a('Company Staff Roles', ['userrole'], ['class' => 'btn green']) ?> 
		<?= Html::a('Update Staff Role', ['upsrole', 'id' => $model->id], ['class' => 'btn green']) ?>
		<?= Html::a('Terminate This Role', ['upstaffrole', 'id' => $model->id], ['class' => 'btn green']) ?>
    </p>
