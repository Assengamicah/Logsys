...
class LogisticsRoles extends Model
{
	...
	public static function logAction($module,$task)
	 {
	  $id = Yii::$app->user->id;
	  $ip = $_SERVER['REMOTE_ADDR'];
	  $tsk = str_replace("'","''",$task);
	  $q = "INSERT INTO oplogs(empid,ipaddress,module,task,cdate,ctime) VALUES('$id','$ip','$module','$tsk',CURDATE(),CURTIME())";
	  $role = Yii::$app->db->createCommand($q)->execute();
